...
public class MyRadRailsEditorInput extends EmptyEditorInput implements
        IPersistableElement {
    ...
    public String getFactoryId() {
        return MyRadRailsElementFactory.ID;
    }
    ...
    public void saveState(IMemento memento) {
        PortalPlugin.getDefault().getPreferenceStore().setValue(
                IPreferenceConstants.MY_APTANA_PREVIOUSLY_OPENED,
                MyRadRailsEditor.isOpen());
    }
