 ...
 * @author
 */
public class ERBCompletionProposal extends UnifiedCompletionProposal
{

	String location = null;

	/**
	 * ERBCompletionProposal
	 * 
	 ...
	 * @param location
	 */
	public ERBCompletionProposal(String replacementString, int replacementOffset,
			...
			IUnifiedViewer unifiedViewer, Image[] userAgentImages, String location)
	{
		super(replacementString, replacementOffset, replacementLength, cursorPosition, image, displayString,
				contextInformation, additionalProposalInfo, objectType, unifiedViewer, userAgentImages);
		this.location = location;
	}

	/**
	 * @see com.aptana.ide.editors.unified.contentassist.UnifiedCompletionProposal#getFileLocation()
	 */
	@Override
