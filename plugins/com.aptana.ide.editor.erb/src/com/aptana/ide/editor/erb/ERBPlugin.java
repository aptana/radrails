 ...
 */
public class ERBPlugin extends AbstractUIPlugin
{
	 ...
	 * The plug-in ID
	 */
	public static final String PLUGIN_ID = "com.aptana.ide.editor.erb"; //$NON-NLS-1$

	/**
	 * The shared instance
	 */
	private static ERBPlugin plugin;
	 ...
	 */
	public static ERBPlugin getDefault()
	{
		return plugin;
	}
