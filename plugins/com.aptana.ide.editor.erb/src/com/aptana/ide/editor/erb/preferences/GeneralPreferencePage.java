...
public class GeneralPreferencePage extends CoreEditorPreferencePage
{
	...
	{
		super(GRID);
		setPreferenceStore(ERBPlugin.getDefault().getPreferenceStore());
	}
	...
	public void createFieldEditors() 
	{
		...
		addField(new BooleanFieldEditor(IPreferenceConstants.CONTENT_ASSIST_DEBUG, "Log debug level messages during content assist", comp));
	}
	...
	{
		return "The Aptana ERB Editor edits Embedded Ruby files.";
	}
	...
	{
		return "com.aptana.ide.editors.ERBEditor";
	}
	...
	{
		return ERBPlugin.getImageDescriptor("images/erb_file.png");
	}
}
