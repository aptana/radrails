 ...
 */
public class ERBUntitledFileWizard extends UntitledTextFileWizard implements INewWizard
{
	/**
	...
	protected String getInitialFileContents()
	{
		...
		pw.println("<html>"); //$NON-NLS-1$
		pw.println("    <head>"); //$NON-NLS-1$
		pw.println("        <title>ERB File</title>"); //$NON-NLS-1$
		pw.println("    </head>"); //$NON-NLS-1$
		pw.println("    <body>"); //$NON-NLS-1$
		pw.println("        <p>Hello from ERB</p>"); //$NON-NLS-1$
		pw.println("    </body>"); //$NON-NLS-1$
		pw.println("</html>"); //$NON-NLS-1$
